...
ALTER TABLE productos ADD CONSTRAINT productos_updated_by_fk FOREIGN KEY(update_by) REFERENCES users(id);
ALTER TABLE bodegas ADD CONSTRAINT bodegas_users_fk FOREIGN KEY(id_responsable) REFERENCES users(id);
ALTER TABLE bodegas ADD CONSTRAINT bodegas_created_by_fk FOREIGN KEY(created_by) REFERENCES users(id);
ALTER TABLE bodegas ADD CONSTRAINT bodegas_update_by_fk FOREIGN KEY(update_by) REFERENCES users(id);
ALTER TABLE inventarios ADD CONSTRAINT inventarios_bodegas_fk FOREIGN KEY(id_bodega) REFERENCES bodegas(id);
ALTER TABLE inventarios ADD CONSTRAINT inventarios_productos_fk FOREIGN KEY(id_producto) REFERENCES productos(id);
ALTER TABLE inventarios ADD CONSTRAINT inventarios_created_by_fk FOREIGN KEY(created_by) REFERENCES users(id);
ALTER TABLE inventarios ADD CONSTRAINT inventarios_update_by_fk FOREIGN KEY(update_by) REFERENCES users(id);
ALTER TABLE historiales ADD CONSTRAINT historiales_bodegas_fk FOREIGN KEY(id_bodega_origen) REFERENCES bodegas(id);
ALTER TABLE historiales ADD CONSTRAINT historiales_id_bodega_destino_fk FOREIGN KEY(id_bodega_destino) REFERENCES bodegas(id);
ALTER TABLE historiales ADD CONSTRAINT historiales_id_inventario_fk FOREIGN KEY(id_inventario) REFERENCES inventarios(id);
ALTER TABLE historiales ADD CONSTRAINT historiales_created_by_fk FOREIGN KEY(created_by) REFERENCES users(id);
ALTER TABLE historiales ADD CONSTRAINT historiales_update_by_fk FOREIGN KEY(update_by) REFERENCES users(id);
